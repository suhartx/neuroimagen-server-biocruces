#!/usr/bin/env sh
set -eu
for file in architecture roadmap deployment user-manual developer-manual operations-manual security processing-pipeline api testing troubleshooting tfm-technical-summary; do
